<footer class="relative bg-yellow-600 pt-8" >
        ...
        <div class="flex flex-wrap text-left lg:text-left">
          <div class="w-full lg:w-6/12 px-4 mt-6">
            ...
            <div class="mt-6 lg:mb-0 mb-6">
                <p class="text-lg font-medium text-slate-200 my-3">Follow Kami</p>
          ...
          <div class="w-full lg:w-6/12 px-4 mt-4">
            <div class="flex flex-wrap items-top mb-6">
              <div class="w-full lg:w-4/12 px-4 ml-auto">
                <span class="block uppercase text-yellow-400 text-lg font-semibold mb-2">Menu</span>
                <ul class="list-unstyled">
                  <li>
                    <a class="text-white hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="">Home</a>
                  </li>
                  <li>
                    <a class="text-white hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="">Catering</a>
                  </li>
                  <li>
                    <a class="text-white hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="">Menu</a>
                  </li>
                  <li>
                    <a class="text-white hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="">Order</a>
                  </li>
                </ul>
              </div>
              <div class="w-full lg:w-4/12 px-4 ml-auto">
                <span class="block uppercase text-yellow-400 text-lg font-semibold mb-2">Contact</span>
                <p class="text-white font-medium text-base">
                    08923102912 <br> info@bergerax.com <br> 1211, Bantul, Yogyakarta
                </p>
              </div>
    ...
    <path style="fill:#A04223;" d="M466.481,330.707H45.519c-17.555,0-31.786-14.231-31.786-31.786V281.78
    ...
    <g>
      <path style="fill:#EEEA05;" d="M488.655,242.048c0.218-6.771,0.36-15.563-0.352-22.382c-4.615-50.976-27.987-98.188-65.816-132.95
      ...
      <path style="fill:#FF0F0F;" d="M256,150.211c-7.584,0-13.732-6.148-13.732-13.732v-31.571c0-7.584,6.148-13.732,13.732-13.732
        c7.584,0,13.732,6.148,13.732,13.732v31.572C269.732,144.063,263.584,150.211,256,150.211z"/>
      <path style="fill:#09F919;" d="M343.2,144.582c-3.514,0-7.03-1.342-9.71-4.022l-27.182-27.182c-5.362-5.362-5.362-14.058,0-19.422
      ...
      <path style="fill:#98E508;" d="M168.8,144.582c-3.514,0-7.03-1.342-9.71-4.022c-5.362-5.362-5.362-14.058,0-19.422l27.182-27.182
